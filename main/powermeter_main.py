...
class PowerMeter_nocam:
    def __init__(self, gain: float=0.2, tau: float=0.3, offset: float=3, buffer_size: int=32, time_series: int=30):
...
class PowerMeter(PowerMeter_nocam):
    def __init__(self, gain: float=1, tau: float=0.5, offset=3, buffer_size: int = 32):
        super().__init__(gain, tau, offset, buffer_size)
